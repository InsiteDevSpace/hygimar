    ...
    c = {
              ...
              t(this).on("translate.owl.carousel", function (e) {
                ...
                t(this).on("translated.owl.carousel", function (o) {
                  ...
                  if (t(this).find(".owl-item.active")[0] !== i[0]) {
                    for (var a = 0; a < e.length; a++) clearTimeout(e[a]);
                    (e = e.splice()),
                      i
                        .find(".appear-animate")
                  ...
                  n.find(".owl-item.active .appear-animate").each(function () {
                    var i,
                      o,
                      n,
                      a = t(this);
      ...
      initProductsScrollLoad: function (e) {
        var i,
          ...
          n = function (e) {
            window.pageYOffset >
              i + o.outerHeight() - window.innerHeight - 150 &&
                ...
                success: function (e) {
                  ...
                  o.data("load-state", "loading"),
                    ...
                    setTimeout(function () {
                      o.append(i),
                        setTimeout(function () {
                          o.find(".col-6.fade:not(.in)").addClass("in");
                        }, 200),
                        o.data("load-state", "loaded"),
                        a >= 2 && o.next().css("display", "none");
                    }, 1500);
                  var a = parseInt(
              ...
              ? o.forEach(function (e, o) {
                  if (e.mobile === !n) {
                    ...
                    (e.height = a.outerHeight(!0)),
                      (e.offset = r.offset ? r.offset : a.offset().top),
              ...
              : ((o = []),
                (i = t(".sticky-header").each(function () {
                  var e = t(this),
                    ...
                    n = {};
                  i && (n = JSON.parse(i.replace(/'/g, '"').replace(";", ""))),
            ...
            if (992 > t(window).width()) {
              ...
              if (
                (i.each(function (i) {
                  ...
                  !1 !== r.mobile && l + c > r.offset + r.paddingTop
                    ...
                    : (!0 !== r.mobile && !n.hasClass("fixed") && e) || s(n);
                }),
              ...
              i.each(function (i) {
                ...
                !0 !== r.mobile && l + c > r.offset + r.paddingTop
                  ? n.hasClass("fixed") || a(n, r, c)
                  : (!1 !== r.mobile && !n.hasClass("fixed") && e) || s(n);
              });
            }
          };
        ...
        Object.keys(o).forEach(function (e) {
          ...
          t(".home-slider.with-dots-container").each(function () {
            ...
            o.eq(0).addClass("active"),
              ...
              o.click(function () {
                var o = t(this),
                  n = (o.parent().filter(i).length ? o : o.parent()).index();
      ...
      lightBox: function () {
        ...
        (e =
          ...
          t(".prod-full-screen").click(function (e) {
            ...
            (o = e.currentTarget.closest(".product-slider-container")
              ...
              t(e.currentTarget).closest(".team-info").length > 0 &&
                (o = t(e.currentTarget).closest(".team-info").parent().index()),
              t.magnificPopup.open(
                {
                  items: i,
          ...
          t("body").on("click", "a.btn-quickvieww", function (e) {
            e.preventDefault();
            var i = t(this);
            i
            ...
            if (
              ...
              var p = function () {
                (n = e.offset()),
                  ...
                  r.css({
                    transform:
                      "translate3d(0, " + (s - 50 + l.offset) + "px, 0)",
            ...
            : e.$thumbs.hasClass("owl-carousel") ||
              ...
              e.$thumbs
                ...
                .owlCarousel(
                  t.extend(
                    !0,
                    e.isQuickview ? { onInitialized: a, onResized: a } : {},
                    {
                      margin: 8,
                      items: 4,
                      dots: !1,
            ...
            (u.appendTo(i).css("top", -o).find("img")[0].onload = function () {
              (o += u[0].offsetHeight + p.space),
                ...
                u.offset().top - window.pageYOffset < 0 &&
                  (p.close(), u.css("top", -o + u[0].offsetHeight + p.space)),
                u
